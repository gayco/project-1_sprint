...
export default function ServicesPageIntro() {
  ...
  return (
    <div ref={wrapperRef} className="flex flex-col gap-2">
      ...
      {/* Line 3 */}
      <div className="w-full flex justify-center md:justify-start md:pl-[30%]">
      ...
      {/* Line 4 */}
      <div className="w-full flex justify-center md:justify-start md:pl-[46%]">
        <p ref={el => { lineRefs.current[3] = el; }} className={`${lineClass} whitespace-nowrap`}>
          identity.
        </p>
      </div>
